...
#define __WI_LIBCPP_BOOL_CONSTANT(__b) integral_constant<bool,(__b)>
    ...
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 0, 1> : public false_type {};
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 1, 1> : public false_type {};
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 2, 1> : public false_type {};
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 3, 1> : public false_type {};

    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 0, 2> : public false_type {};
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 1, 2> : public false_type {};
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 2, 2> : public false_type {};
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 3, 2> : public false_type {};

    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 0, 3> : public false_type {};
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 1, 3> : public false_type {};
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 2, 3> : public false_type {};
    template <class _T1, class _T2> struct __wistd_is_convertible<_T1, _T2, 3, 3> : public true_type {};

    template <class _T1, class _T2> struct __WI_LIBCPP_TEMPLATE_VIS is_convertible
        : public __wistd_is_convertible<_T1, _T2>
    {
